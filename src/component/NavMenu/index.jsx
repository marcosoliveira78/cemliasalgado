...
import { Nav, Navbar, Container, NavDropdown, OverlayTrigger, Tooltip } from 'react-bootstrap';
import { FaDoorOpen, FaUserCircle, FaUserTie, FaWhmcs, FaBookReader } from 'react-icons/fa';
...
function NavMenu() {
    ...
    //         <>
    //             <OverlayTrigger placement="bottom-end" overlay={<Tooltip id={uniqueId()}>Fale com a CSE</Tooltip>}>
                            ...
                            {/* {login && (
                                    <Navbar.Text>
                                        <a onClick={() => refreshSession(time)} href={`${urlEllevo}/Principal.asp?SessionID=${sessionID}`} target="_blank" rel="noreferrer">
                                            <OverlayTrigger placement="bottom" overlay={<Tooltip id={uniqueId()}>Ambiente Ellevo</Tooltip>}>
                                                <img src={logoEllevo} alt="Ellevo" className="sub-menu-imagem" />
                                            </OverlayTrigger>
                                        </a>
                                    </Navbar.Text>
                                )} */}
                                    ...
                                    admin && (
                                        <>
                                            <NavDropdownMenu className="dropdown" title={adminNavDropdownTitle} id="AdiministracaoDropdown">
                                                ...
                                                <NavDropdown.Item as="span" style={{ paddingLeft: '10px' }}>
